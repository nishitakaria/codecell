...
class encrypt
{
	public static void main(String args[])
	{
		...
		String message = VigenereCipherEncrypter.encrypt(text, cipherKey);
...
just finished the tsec codecell challenge
Enter the keyword:
codecell
Encrypted message: livx jtykgkif esg wwgg nqrhggpw evdpniyrg
*/		
